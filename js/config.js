...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('dashboards_top.dashboard', {
            url: "/dashboard",
            templateUrl: "views/dashboard.html",
            controller: dashbCtrl,
            data: { pageTitle: 'Dashboard' },
        })
        .state('dashboards_top.profiles', {
            url: "/profiles",
        ...
        .state('dashboards_top.documents', {
            url: "/documents",
        ...
        .state('app.customer_request', {
            url: "/customer_request",
            templateUrl: "views/customer-request.html",
            controller: customerProfileCtrl,
            data: { pageTitle: 'Profile' }
        })
        .state('app.profile_2', {
        ...
        .state('welcome', {
            ...
            data: { pageTitle: 'Welcome page', specialClass: 'landing-page' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('sign-in', {
            ...
            data: { pageTitle: 'Sign in', specialClass: 'landing-page' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
