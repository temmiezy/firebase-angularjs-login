        ...
        if(isValid){
            ...
            firebase.auth().signInWithEmailAndPassword($scope.email, $scope.password)
                .then(function(){
                    ...
                    $log.info(user.uid);
                    window.location.href = '#/dashboards_top/dashboard';
...
function profileCtrl($scope, Upload, $timeout) {
        ...
        //angular.element(document).ready(function () {
            ...
            firebase.database().ref('/users/' + user.uid).once('value')
                .then(function(snapshot) {
                    //$scope.testmi = 'test mi ni111111';
                    $( "#address1" ).attr({value : snapshot.val().addressMain });
                    $( "#address2" ).attr({value : snapshot.val().addressOpt });
                    $( "#city" ).attr({value : snapshot.val().city });
                    $( "#pCode" ).attr({value : snapshot.val().postalCode });
                    $( "#phoneMobile" ).attr({value : snapshot.val().mobilePhone });
                    $( "#phoneWork" ).attr({value : snapshot.val().workPhone });
                    $('#country').val(snapshot.val().country);
                    $('#state').val(snapshot.val().state);
                    
                    console.log(snapshot.val().addressMain);
                    $scope.address1 = snapshot.val().addressMain;
                    $scope.address2 = snapshot.val().addressOpt;
                    $scope.city = snapshot.val().city;
                    $scope.pCode = snapshot.val().postalCode;
                    $scope.phoneMobile = snapshot.val().mobilePhone;
                    $scope.phoneWork = snapshot.val().workPhone;
                    $scope.state = snapshot.val().state;
                    $scope.country = snapshot.val().country;

                        console.log($scope.phoneMobile);
    ...
    $scope.submitForm = function(){
        ...
        $scope.addProfileRef = firebase.database().ref('users/' + user.uid);
        $scope.addProfileRef.update({ 
            
            name : user.displayName,
            email : $scope.myEmail,
            addressMain: $scope.address1,
            addressOpt : $scope.address2,
            city : $scope.city,
            state: $scope.state,
            country : $scope.country,
            postalCode: $scope.pCode,
            mobilePhone : $scope.phoneMobile,
            workPhone: $scope.phoneWork, 
    ...
    $scope.upload = function (file) {
        ...
        $scope.myFimeName = 'profile.jpg';
        $scope.uploadTask = $scope.storageRef.child('profile/' + user.uid + '/'+ $scope.myFimeName).put(file);
        
        $scope.uploadTask.on('state_changed', function(snapshot){
          ...
          //$scope.downloadURL = uploadTask.snapshot.downloadURL;
            console.log($scope.uploadTask.snapshot.downloadURL);
            $scope.adaNameRef = firebase.database().ref('users/' + user.uid);
            $scope.adaNameRef.update({ profilePhotoUrl: $scope.uploadTask.snapshot.downloadURL });
            //location.reload();
        });
    };
...
function documentsCtrl($scope, Upload, $timeout){
    ...
    $scope.upload = function (file) {
        ...
        $scope.storageRef = firebase.storage().ref();
        $scope.myFimeName = 'license.jpg';
        $scope.uploadTask = $scope.storageRef.child('license/' + user.uid + '/'+ $scope.myFimeName).put(file);
        ...
        $scope.uploadTask.on('state_changed', function(snapshot){
          ...
          //$scope.downloadURL = uploadTask.snapshot.downloadURL;
            //console.log($scope.uploadTask.snapshot.downloadURL);
            $scope.adaNameRef = firebase.database().ref('license/' + user.uid);
            $scope.adaNameRef.update({ 
                
                barberlicense: $scope.uploadTask.snapshot.downloadURL,
                status: 'pending',
    ...
    $scope.uploadid = function (file) {
        ...
        $scope.storageRef = firebase.storage().ref();
        $scope.myFimeName = 'id.jpg';
        $scope.uploadTask = $scope.storageRef.child('identification/' + user.uid + '/'+ $scope.myFimeName).put(file);
        ...
        $scope.uploadTask.on('state_changed', function(snapshot){
          ...
          //$scope.downloadURL = uploadTask.snapshot.downloadURL;
            //console.log($scope.uploadTask.snapshot.downloadURL);
            $scope.adaNameRef = firebase.database().ref('identification/' + user.uid);
            $scope.adaNameRef.update({ 
                ...
                alert('Identification successfully updated');
    ...
    $scope.uploadother = function (file) {
        
        $scope.storageRef = firebase.storage().ref();
        $scope.myFimeName = 'otherdoc.jpg';
        $scope.uploadTask = $scope.storageRef.child('other/' + user.uid + '/'+ $scope.myFimeName).put(file);
        ...
        $scope.uploadTask.on('state_changed', function(snapshot){
          ...
          //$scope.downloadURL = uploadTask.snapshot.downloadURL;
            //console.log($scope.uploadTask.snapshot.downloadURL);
            $scope.adaNameRef = firebase.database().ref('other/' + user.uid);
            $scope.adaNameRef.update({ 
    ...
    $scope.gofacebook = function(){
        ...
        firebase.auth().signInWithPopup(provider).then(function(result) {
          ...
          $scope.credential = result.credential;
            ...
            window.location.href = '#/app/customer_profile';
        }, function(error) {
          ...
          if (error.code === 'auth/account-exists-with-different-credential') {
            auth.fetchProvidersForEmail($scope.email).then(function(providers) {
...
function customerProfileCtrl($scope){
